...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@200..800|Montserrat:ital,wght@0,100..900;1,100..900|Quicksand:wght@300..700" rel="stylesheet">
    <style>
        .form-group.note-form-group.note-group-select-from-files {
            display: none;
        }

        /* Custom Styling for VirtuaLink */
        .brand-text {
        ...
        .brand-text .virtua {
            color: #000000; /* Black color for Virtua */
        }
        .brand-text .link {
            color: #0288d1; /* Blue color for Link */
        }
    </style>
</head>
<body>
