		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<textarea name="achievements" id="achievements" class="form-control" rows="4" required><?php echo isset($meta['achievements']) ? htmlspecialchars($meta['achievements']) : '' ?></textarea>
				</div>
                <div class="form-group">
					<label for="commend" class="control-label">Commend user?</label>
					<select name="commend" id="commend" class="form-control form-control-sm rounded-0" required>
                        <option value="1" <?php echo isset($meta['commend']) && $meta['commend'] == 1 ? 'selected' : '' ?>>Yes</option>
                        <option value="0" <?php echo isset($meta['commend']) && $meta['commend'] == 0 ? 'selected' : '' ?>>No</option>
                    </select>
				</div>
				<div class="form-group">
